 ...
 * Descripcion: programa que realiza la transformacion Euclidiana a una imagen
 *===========================================================================*/'''
...
def transformar():
    ...
    escala=1                                                  #No altero la escala

    metodo= 1                                                 #Indico metodo a utilizar

    #METODO1
    if metodo==1:
        M= cv2.getRotationMatrix2D(centro, angulo.get(), escala)   #Obtengo una matriz 2x3 de rotacion
    ...
    if metodo==2:
        ...
        M=np.float32([[math.cos(math.radians (angulo.get())), math.sin(math.radians (angulo.get())), traslacion_x.get()],
                 [-math.sin(math.radians (angulo.get())), math.cos(math.radians (angulo.get())), traslacion_y.get()]])
